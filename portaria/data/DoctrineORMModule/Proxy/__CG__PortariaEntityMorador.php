 ...
 */
class Morador extends \Portaria\Entity\Morador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'id', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'nome', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'cpf', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'documento', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'celular', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'datanascto', '' . "\0" . 'Portaria\\Entity\\Morador' . "\0" . 'unidade'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Morador $proxy) {
    ...
    public function getDatanascto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDatanascto', []);

        return parent::getDatanascto();
    }
    ...
    public function setDatanascto($datanascto)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDatanascto', [$datanascto]);

        return parent::setDatanascto($datanascto);
    }
     ...
     * {@inheritDoc}
     */
    public function setUnidade(\Portaria\Entity\Unidade $unidade)
    {
