 ...
 */
class Modelo extends \Portaria\Entity\Modelo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Portaria\\Entity\\Modelo' . "\0" . 'id', '' . "\0" . 'Portaria\\Entity\\Modelo' . "\0" . 'descricao', '' . "\0" . 'Portaria\\Entity\\Modelo' . "\0" . 'marca'];
        }
     ...
     * {@inheritDoc}
     */
    public function setMarca(\Portaria\Entity\Marca $marca)
    {
